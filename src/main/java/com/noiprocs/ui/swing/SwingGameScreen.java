...
public class SwingGameScreen extends ConsoleGameScreen {
    ...
    private void renderFromMaps(PlayerModel playerModel) {
        try {
            ...
            header.append('\n');
            newDocument.insertString(newDocument.getLength(), header.toString(), getOrCreateStyle(newDocument, Color.WHITE));
            ...
            for (int i = 0; i < HEIGHT; i++) {
                ...
                if (segmentColor != null && !segmentColor.equals(Color.WHITE)) {
                    newDocument.insertString(newDocument.getLength(), textSegment.toString(), getOrCreateStyle(newDocument, segmentColor));
            ...
            newDocument.insertString(newDocument.getLength(), footer.toString(), getOrCreateStyle(newDocument, Color.WHITE));
